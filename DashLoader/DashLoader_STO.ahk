...
Gui, Add, Picture, x0 y0 w516 +BackgroundTrans, \\epicuaefs\Data\Materials\MTO\exe tools\DashLoader\Source\bg.jpg
Gui,Add,Picture,w100 h50 x400 y5 +BackgroundTrans,\\epicuaehqfs\Data\Materials\MTO\exe tools\DashLoader\Source\epic_logo_8_5in.png
Gui, Color, , 7A00CC
Gui, Font, +cFFFFFF
...
xl.quit		
STOLOCATION = C:\Users\%A_UserName%\Desktop\SPLGN_%JOB%_%TRANS%.xlsx
SUBSTRING = STO for %JOB% - %TRANS%
BODSTRING = All,`nSee the attached STO for Job %JOB% - %TRANS%
			...
			MsgBox, 4,Spoolgen Report Created, Would you like to open the report? (press Yes or No)
